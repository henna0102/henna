...
(371, 1, 12, '2022-03-09 15:30:40', '雪山風景好，看日出的好地方', 372),
(373, 1, 20, '2022-03-14 16:18:47', '雪山好好玩 去好幾次都不會膩', 373);
...
(7, '雪山行', 1, '2022-03-18', '2022-03-18', '我是阿傑，大家都叫我傑哥，歡迎大家一起來雪山玩，玩累了就直接睡覺，沒問題的。');
...
(20, '傑哥', 'dragonnestk@gmail.com', 'a020202', '0978567428', '我是臺灣長跑運動員與創業家。參與完成人類首次橫渡撒哈拉沙漠、世界四大極地超級馬拉松巡迴賽總冠軍、發起擁抱絲路計劃，帶團隊穿越絲路等壯舉。', 1, '2022-03-14 14:39:39');
...
--
ALTER TABLE `tripchatboard`
  MODIFY `number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=375;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `trips`
--
ALTER TABLE `trips`
  MODIFY `tripId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
